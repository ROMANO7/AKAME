...
const spinner2 = { 
  "interval": 150,
  "frames": ["NAO ESQUECA DO PIX DO YURI MODZ"]}
...
var guxta = ['AKAME MD 2.0', 'AKAME MD', 'AKAME BOT']
bot = guxta[Math.floor(Math.random() * guxta.length)]

var fontes = ['simple', 'block', 'shade', 'pallet', 'slick']
fonts = fontes[Math.floor(Math.random() * fontes.length)]


const banner2 = cfonts.render(('NAO ESQUECA DO PIX DO YURI MODZ'), {
font: 'console',
align: 'center',
gradrient: [`${cor4}`,`${cor2}`], 
...
authorname = 'AKAME-MD-2.0'
packname = '-JR-'
  
function addMetadata(packname, author) {	
if (!packname) packname = '-JR-'; if (!author) author = 'AKAME-MD-2.0';	
...
chyt = `5565993065507@s.whatsapp.net`
